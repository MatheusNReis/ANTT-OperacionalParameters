...
'Zero times are not purged
'Count Zero Times according to classification empty, 1 or 2
...
'Tempos zeros não são expurgados
'Contagem de tempos zeros conforme código classificação vazio, 1 ou 2

'Version: 6.0

'Created by Matheus Nunes Reis on 13/02/2025
...
''''''' Etapa de, linha por linha, realizar análise do 1º atendimento, expurgar dados com tempos <=0, substitiur os recursos pelos tipos de veículos, verificar nem guincho nem ambulância,
    ...
    Dim TempoZeroVazio As Long, TempoZero1 As Long, TempoZero2 As Long
    TempoZeroVazio = 0
    TempoZero1 = 0
    TempoZero2 = 0
    ...
    For i = 2 To LastRowObjWorksheet 'i é linha na ObjWorksheet
        ...
        'Contagem de tempos zeros de classificação vazio, 1 ou 2
        If Tempo = 0 And (ValorRecurso = "Ambulância C" Or ValorRecurso = "Ambulância D" Or ValorRecurso = "Guincho Leve" Or ValorRecurso = "Guincho Pesado") _
                    And Base = "" Then
            TempoZeroVazio = TempoZeroVazio + 1
            
        ElseIf Tempo = 0 And (ValorRecurso = "Ambulância C" Or ValorRecurso = "Ambulância D" Or ValorRecurso = "Guincho Leve" Or ValorRecurso = "Guincho Pesado") _
                    And Base = 1 Then
            TempoZero1 = TempoZero1 + 1
            
        ElseIf Tempo = 0 And (ValorRecurso = "Ambulância C" Or ValorRecurso = "Ambulância D" Or ValorRecurso = "Guincho Leve" Or ValorRecurso = "Guincho Pesado") _
                    And Base = 2 Then
            TempoZero2 = TempoZero2 + 1
        ...
        'ElseIf PrimeiroAtend = 0 And t_ocorrencia = 0 And (Base = "2" Or Base = "") Then 'PrimeiroAtend = 0 relaciona-se ao t_ocorrencia
 ...
 '''''''
    ...
    DadosExpWorksheet.Range("D5").Value = "Contagens:"
    DadosExpWorksheet.Range("D6").Value = "T0_Vazio"
    DadosExpWorksheet.Range("D7").Value = TempoZeroVazio
    DadosExpWorksheet.Range("E6").Value = "T0_1"
    DadosExpWorksheet.Range("E7").Value = TempoZero1
    DadosExpWorksheet.Range("F6").Value = "T0_2"
    DadosExpWorksheet.Range("F7").Value = TempoZero2
